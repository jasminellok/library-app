...
book_3 = Book.create(title: 'harry potter book#1')

book_4 = Book.create(title: 'Way of Kings')
book_5 = Book.create(title: 'Words of Radiance')
book_6 = Book.create(title: 'The Stormlight Archive Book 1')
...
BookAuthor.create(book_id: book_3.id , author_id:  author_1.id, duplicate_of: book_1.id)

BookAuthor.create(book_id: book_4.id , author_id:  author_2.id)
BookAuthor.create(book_id: book_5.id , author_id:  author_2.id)
BookAuthor.create(book_id: book_6.id , author_id:  author_2.id, duplicate_of: book_4.id)
